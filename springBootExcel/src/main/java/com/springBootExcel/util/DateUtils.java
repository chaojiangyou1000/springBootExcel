...
public class DateUtils {
	...
	public static long date_between(Date end, Date begin) {
		 ...
		 * Date begin=dfs.parse("2004-01-02 11:30:24"); Date end =
		 * dfs.parse("2004-01-02 11:31:40");
		 */
	 ...
	 * 
	 * @param dateStr
	 *            时间字符串 2018-05-05 12:11
	 * @param dateFormat
	 *            时间格式 yyyy-MM-dd HH:mmssSSS
	 * @param n
	 *            加多少天
	 */
